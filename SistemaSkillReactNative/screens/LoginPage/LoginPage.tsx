...
import { CadastroScreenNavigationProp, loginType, senhaRecType } from '../../interfaces/TypesUsuario';
  ...
  return (
    <View style={styles.container}>
        <View style={styles.wrapper}>
            ...
            <View style={styles.inputBox}>
                <TextInput secureTextEntry={mostrarSenha} style={styles.input} placeholder='Senha' value={senha} onChangeText={setSenha}></TextInput>
